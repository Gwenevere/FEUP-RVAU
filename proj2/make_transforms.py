...
movie_name = args.n
movie_rating = args.r
img = cv2.imread("posters/" + args.i)
img2 = cv2.imread(args.i)
...
if not os.path.exists(PREPARATION_DIR+ '/' + os.path.splitext(args.i)[0]):
    os.mkdir(PREPARATION_DIR + '/' + os.path.splitext(args.i)[0])
    print("Created ./preparation/" + os.path.splitext(args.i)[0] +  " directory")
...
cv2.imwrite(PREPARATION_DIR + "/" + image_name + '/' + args.i, img)